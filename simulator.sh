...
DRIVER_URI="https://127.0.0.1:5000/tracking/mobile/driver"
DRIVER_USERNAME="deniro"
DRIVER_TOKEN="3c6cd670b094"
LAT="40.781947"
LON="-73.971977"

PASSENGER_URI="https://127.0.0.1:5000/tracking/mobile/passenger"
...
curl -k -d username=$DRIVER_USERNAME -d token=$DRIVER_TOKEN -d ride_id=$RIDE_ID -d lat=$LAT -d lon=$LON "$DRIVER_URI"

# passenger (mobile app) polling API for last tracked address
echo -e "\nPASSENGER: getting last tracked address"
curl -k "$PASSENGER_URI?username=$PASSENGER_USERNAME&token=$PASSENGER_TOKEN&ride_id=$RIDE_ID"
